    ...
    private createUnitRows(allUnits:UnitData[]):JSX.Element[] {
        ...
        for (const unitData of allUnits) {
            ...
            for (const status of currentStatuses) {
                statusInfo.push(
                    <p
                        className="status-info-text"
                        key={UnitCondition[status.statusId]}
                    >
                        {`${UnitCondition[status.statusId]}, ${status.endsRound - this.activeRound}r`}
                    </p>
                );
            }
            ...
            const newRow = <tr key={`unit-data-${unitData.uuid}`} className={isUnitTurn ? "active-turn" : undefined}>
                ...
                <td><input
                        type="number"
                        id={unitData.uuid}
                        defaultValue={unitData.initiativeRoll}
                        onKeyDown={this.onInputKeyDown}
                ...
                <td><input
                        type="number"
                        id={unitData.uuid}
                        defaultValue={unitData.initiativeMod}
                        onKeyDown={this.onInputKeyDown}
                        onChange={this.onInitiativeModChange}
                    />
                </td>
                <td><input
                        type="number"
                        id={unitData.uuid}
                        defaultValue={unitData.startingHp}
                        onKeyDown={this.onInputKeyDown}
                        onChange={this.onStartingHpChange}
                    />
                </td>
                {hpChangeRows}
